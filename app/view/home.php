    ...
    <body>
        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
            ...
            <div class="mdl-layout__drawer">
                <span class="mdl-layout-title">AMBITIONS <font size="2" style="color: red">BETA</font></span>
            ...
            <main class="mdl-layout__content">
                ...
                <div class="page-content">
                    <!-- Cover Area -->
                    <div class="cover" style="background-image: url('../../images/pics_cover/<?php echo $_SESSION['pic_cover'] ?>');">
                        <div class="header">
                            <div class="img-circle profile-pic" style="background-image: url('../../images/pics_profile/<?php echo $_SESSION['pic_profile'] ?>');"></div>                            
                            <div class="profile-name"><?php echo $_SESSION['name'] . ' ' . $_SESSION['surname']; ?></div>
